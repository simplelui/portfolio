...
function AboutSkeleton() {
  return (
    <div className="w-full bg-[#1B1B1B] rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 border border-[#2A2A2A] flex flex-col gap-10 animate-pulse">
      {/* About Me Skeleton */}
      <div>
        <div className="h-8 w-40 bg-gray-600 rounded mb-4"></div>
        <div className="h-1 w-10 bg-gray-500 rounded mb-6"></div>
      ...
      {/* What I'm Doing Skeleton */}
      <div>
        <div className="h-7 w-48 bg-gray-600 rounded mb-8"></div>
