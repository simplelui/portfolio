...
export default function Hero() {
  return (
    <motion.section
      className="flex flex-col justify-center items-center text-center py-4 px-4"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 1 }}
    >
      <div className="w-full max-w-3xl bg-[#1B1B1B] rounded-2xl shadow-xl border border-[#2A2A2A] p-12 flex flex-col gap-6">
